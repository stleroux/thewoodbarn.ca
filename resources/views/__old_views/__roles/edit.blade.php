                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">Permission: (Select permissions for this Role)</div>
                                    <div class="panel-body {{ $errors->has('permission') ? 'has-error' : '' }}">
                                        ...
                                        <div class="panel panel-primary panel-borderless">
                                            @foreach($permission as $value)
                                                ...
                                                <label style="font-weight:normal;">
                                                    ...
                                                    <br />
                                                    {{ Form::checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, ['data-toggle=toggle', 'data-on="Yes"', 'data-off="No"', 'data-onstyle="success"', 'data-offstyle="danger"', 'data-size="mini"']) }}
                                                    <br/><br /><br />
                                                </label>
                                                &nbsp;&nbsp;
                                            @endforeach
