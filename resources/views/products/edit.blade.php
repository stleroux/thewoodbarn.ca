...
@section('menubar')
  ...
  @include('layouts.buttons.cancel', ['name'=>'products'])
  @include('layouts.buttons.update', ['name'=>'products'])
@stop

@section('content')
  @include('layouts.partials.section_top', ['name'=>'Edit Product', 'icon'=>'fa-wpforms'])
