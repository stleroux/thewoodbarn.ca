                ...
                <div role="tabpanel" class="tab-pane fade in active" id="viewProfile">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active">
                                    <a href="#general" aria-controls="general" role="tab" data-toggle="tab">General Information</a>
                                </li>
                                <li role="presentation" class="">
                                    <a href="#preferences" aria-controls="preferences" role="tab" data-toggle="tab">User Preferences</a>
                                </li>
                                <li role="presentation" class="">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade in" id="preferences">
                                    <br />
                                    <div class="row">
                                    <div class="col-xs-12">
