...
@section('breadcrumb')
  <li><a href="/">Home</a></li>
  <li class="active">Edit User Profile :: {{ ucwords($user->first_name) }} {{ ucwords($user->last_name) }} ({{ $user->email }})</li>
@stop
                      ...
                      <div class="panel-body">
                        <table class="" width="100%">
                          <tr>
                            ...
                            <td>
                              <span class="pull-right">{{ date('M j, Y', strtotime($user->created_at)) }}</span>
                            </td>
                          </tr>
                          <tr>
                            <th>Updated on</th>
