					...
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>@include('layouts.dateFormat', ['model'=>$comment, 'field'=>'created_at'])</td>
							</tr>
							@endforeach
						</tbody>
					</table>
				...
				<div class="panel-body">
                  ...
                  <a href="" class="" data-toggle="modal" data-target="#viewPostImageModal">
					...
					<dl class="dl-horizontal">
						...
						@include('layouts.author', ['model'=>$post, 'field'=>'user'])
						
					</dl>

					<dl class="dl-horizontal">
						<label>Created At:</label>
						@include('layouts.dateFormat', ['model'=>$post, 'field'=>'created_at'])
					</dl>

					<dl class="dl-horizontal">
						<label>Modified By:</label>
						@include('layouts.author', ['model'=>$post, 'field'=>'modified_by'])
					</dl>

					<dl class="dl-horizontal">
						<label>Last Updated:</label>
						@include('layouts.dateFormat', ['model'=>$post, 'field'=>'updated_at'])
					</dl>
				</div>
			</div>
		</div>
  ...
  <div class="modal fade" id="viewPostImageModal" tabindex="-1" role="dialog" aria-labelledby="viewPostImageModalLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>{{ Html::image("images/posts/" . $post->image, "", array('height'=>'100%','width'=>'100%')) }}</p>
        </div>
        <div class="modal-footer">
