@extends ('layouts.frontend.print')
...
<div class="panel panel-default">
	<div class="panel-heading">From the Recipe Book at TheWoodBarn.ca</div>
							...
							<div class="panel-body">
								<table width="100%">
									...
									<tr>
										...
										<td>@include('layouts.common.dateFormat', ['dateFormat'=>Auth::user()->dateFormat, 'model'=>$recipe, 'field'=>'created_at'])</td>
									</tr>
									<tr>
										<th>Source</th>
										<td>
