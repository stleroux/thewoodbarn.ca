...
{{--   <div class="well well-sm clearfix">
    <div class="pull-right">
      ...
      @if(checkACL('publisher'))
        <a href="{{ route('recipes.published','all') }}" class="{{ Request::is('recipes/published/*') ? "btn-primary": "btn-default" }} btn btn-xs" {{ (Auth::user()->actionButtons == 1) ? 'title=Published' : '' }}>
          {{-- <div class="text text-left">
      ...
      {{--================================================================================================================================--}}
      @if(checkACL('publisher'))
        <a href="{{ route('recipes.nonPublished','all') }}" class="{{ Request::is('recipes/nonPublished/*') ? "btn-primary": "btn-default" }} btn btn-xs" {{ (Auth::user()->actionButtons == 1) ? 'title=Non Published' : '' }}>
          {{-- <div class="text text-left">
            <i class="fa fa-thumbs-o-up" aria-hidden="true"></i> My Favorites
          </div> --}}
              ...
              @foreach ($recipes as $recipe)
                <tr>
                  ...
                  <td class="hidden-sm hidden-xs">
                    @include('layouts.author', ['model'=>$recipe, 'field'=>'user'])
                  </td>
