...
<li class="{{ Request::is('about*') ? "active": "" }}"><a href="/about" style="padding-left: 7px; padding-right: 7px"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span> About Us</a></li>

<li class="{{ Request::is('contact*') ? "active": "" }}"><a href="/contact" style="padding-left: 7px; padding-right: 7px"><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> Contact Us</a></li>
