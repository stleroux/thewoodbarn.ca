	...
	<div class="row">
		<div class="col-md-9">
			<div class="panel panel-danger">
				<div class="panel-heading"><h4>Are you sure you want to delete this user?</h4></div>
        	...
        	<div class="panel panel-danger">
                ...
                <div class="panel-body">
                	{!! Form::open(['route' => ['admin.users.destroy', $user->id], 'method' => 'DELETE']) !!}
                		<div>
                			<a href="{{ route('admin.users.deactivate', $user->id) }}" class="btn btn-warning btn-lg btn-block" title="Deactivate">
                                <span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>
                                De-Activate
                            </a>
                			{!! Form::submit('Delete', ['class' => 'btn btn-danger btn-sm btn-block']) !!}
                            <a href="{{ route('admin.users.index') }}" class="btn btn-default btn-sm btn-block">Cancel</a>
    					</div>
    				{!! Form::close() !!}
    			</div>
    		</div>
