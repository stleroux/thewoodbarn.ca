...
@section('breadcrumb')
	...
	<li><a href="{{ route('admin.recipes.index') }}">Recipes</a></li>
	<li>Import Recipes</li>
@stop

@section('page_top_menu')
<form  action="{{ URL::to('admin/recipes/importExcel') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
	<div class="row">
		<div class="col-md-12">
			<div class="well well-sm clearfix">
				<div class="pull-right">
					...
					{{-- CANCEL BUTTON                                                                                                                  --}}
					{{--================================================================================================================================--}}
					<a href="{{ route('admin.recipes.index') }}" class="btn btn-default btn-xs">
...
<div class='panel-heading panel-relative'>Import Recipes</div>
