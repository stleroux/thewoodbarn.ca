      ...
      <div class="well well-sm clearfix">
        <div class="pull-right">
          ...
          {{-- @ability('admin', 'admin,users_edit,users_edit_admin') --}}
            <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-primary btn-xs" {{ (Auth::user()->actionButtons == 1) ? 'title=Edit' : '' }}>
          ...
          {{-- INDEX BUTTON                                                                                                                   --}}
          {{--================================================================================================================================--}}
          <a class="btn btn-default btn-xs" href="{{ route('admin.users.index') }}">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <div class="panel-heading">Account Information</div>
    		<div class="panel-body">
          <div class="col-md-4">
            @include ('admin/users/panels/creation_info')
          </div>
          <div class="col-md-3">
            @include ('admin/users/panels/role_info')
          </div>
          <div class="col-md-2">
            <div class="panel panel-default">
