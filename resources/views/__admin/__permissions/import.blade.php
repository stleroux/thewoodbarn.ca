      ...
      <div class="well well-sm clearfix">
        <div class="pull-right">
          ...
          <button type="submit" name="submit" class="btn btn-success btn-xs">
            <div class="text text-left">
              <i class="fa fa-save"></i> Import Permissions
            </div>
          </button>
          {{--================================================================================================================================--}}
          {{-- END IMPORT BUTTON                                                                                                              --}}
...
@section('content')
  <form 
    action="{{ URL::to('admin/permissions/importExcel') }}"
    class="form-horizontal"
    method="post"
    enctype="multipart/form-data">

    <div class="panel panel-default">
      <div class='panel-heading panel-relative'>Import Permissions</div>
